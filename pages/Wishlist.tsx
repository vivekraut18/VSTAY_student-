    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Saved Properties</h1>
        </div>
        <button 
      ...
      {likedProperties.length > 0 ? (
        ...
        <div className="bg-white rounded-[3rem] p-24 text-center border border-slate-100 shadow-xl space-y-6">
           ...
           <p className="text-slate-500 max-w-sm mx-auto font-medium">Save properties you love to see them here later. They'll stay saved even after you refresh.</p>
           <button 
            onClick={() => setCurrentPage('listings')}
